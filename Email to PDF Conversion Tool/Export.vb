...
Sub ExportToPdf()
  ...
  Progress.Show
  Progress.Increment 0, "Exporting..."
  ...
  Progress.Increment 100, "Complete!"
...
Private Sub SaveEmails(SelectedEmails, SavePath)
  ...
  For Each SelectedEmail In SelectedEmails
    ...
    Progress.Increment (Counter / SelectedEmails.Count) * 100, "Exporting..."
    Sleep 250
...
Private Sub MergePdfDocuments(PdfPath)
  ...
  For Each FileToMerge In FilesToMerge
    Progress.Increment (Counter / FilesToMerge.Count) * 100, "Merging..."
    Sleep 250
